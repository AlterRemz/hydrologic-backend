...
print('Alat ini akan terus meminta input. Ketik "q" untuk berhenti.\n')

while True:
    print("\n" + "="*45)
    sektor = input('Masukkan nama sektor (cth: Sektor A atau "Q" untuk keluar) : ')

    if sektor.lower() in ['q', 'exit', 'quit']:
        print("Mematikan simulator...")
        break
    try:
        ...
        print("[⚠️ ERROR] Input dibatalkan. Harap masukkan format angka yang valid (contoh: 15.5)!")
